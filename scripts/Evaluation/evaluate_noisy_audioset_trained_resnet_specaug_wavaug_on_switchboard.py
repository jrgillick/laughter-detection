...
checkpoint_dir = '/mnt/data0/jrgillick/projects/laughter-detection/checkpoints/noisy_audioset_resnet_43fps_wav_augment_spec_augment_large_drop07'
...
val_results_df.to_csv("noisy_audioset_trained_resnet_specaug_wavaug_switchboard_val_results.csv",index=None)
...
test_results_df.to_csv("noisy_audioset_trained_resnet_specaug_wavaug_switchboard_test_results.csv",index=None)
