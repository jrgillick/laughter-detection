...
checkpoint_dir = '/mnt/data0/jrgillick/projects/laughter-detection/checkpoints/no_word_resnet_base_bigger_43fps'
...
val_results_df.to_csv("resnet_base_switchboard_val_results.csv",index=None)
...
test_results_df.to_csv("resnet_base_switchboard_test_results.csv",index=None)
