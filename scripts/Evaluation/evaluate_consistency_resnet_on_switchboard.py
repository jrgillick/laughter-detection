...
val_results_df.to_csv("consistency_resnet_switchboard_val_results.csv",index=None)
...
test_results_df.to_csv("consistency_resnet_switchboard_test_results.csv",index=None)